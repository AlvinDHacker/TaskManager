      ...
      </div>
      {
        nav ? (
          <div className='fixed h-screen w-full bg-white/90 flex flex-col justify-center items-center z-20'>
            ...
            <a onClick={handleNav} href='#login' className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-green-100 shadow-gray-400 m-3 p-3 cursor-pointer hover:scale-105 ease-in duration-200'>
      ...
      <div className='sticky top-0 backdrop-blur-3xl z-10 mx-auto shadow-lg'>
        <div className='flex w-screen'>
          <div className="flex lg:flex-1 m-4">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Alphamatics</span>
              <img className="h-8 w-auto" src={logo} alt="" />
            </a>
          </div>
          ...
          <div className='hidden md:flex md:flex-1 md:justify-end'>
            <a href='#login' className='font-bold flex rounded shadow-lg bg-green-500 m-3 p-2 cursor-pointer hover:scale-110 ease-in duration-300'>
              Log in <BsPerson size={22} />
            </a>
          </div>
        </div>
      </div>
